    ...
    <div className="animate-fade-in-up space-y-5 pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="h-[200px] lg:h-[240px] w-full">
            {history.length > 0 ? (
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie data={contentData} cx="50%" cy="50%" innerRadius={55} outerRadius={75} paddingAngle={5} dataKey="value">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5 lg:p-6">
          ...
          <p className="text-xs text-gray-400 mb-4 lg:mb-6">Kumulatif aksi yang telah dilakukan</p>
          <div className="h-[200px] lg:h-[240px] w-full">
            {history.length > 0 ? (
              <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5 lg:p-6">
          ...
          <div className="space-y-1">
            <Link href="/comments" className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors group">
              <svg className="w-5 h-5 text-gray-400 group-hover:text-indigo-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
