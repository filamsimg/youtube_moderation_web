...
export default function ThemeToggle({ className = '' }) {
  ...
  return (
    ...
    >
      <span className={`block transition-all duration-300 ${isAnimating ? 'animate-theme-switch' : ''}`}>
        {isDark ? (
          /* Moon — mode gelap aktif, klik untuk mode terang */
          <svg
          ...
          /* Sun — mode terang aktif, klik untuk mode gelap */
          <svg
